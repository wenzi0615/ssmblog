	...
	<div id="wrapper">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav">
				...
				<li><a href="index.jsp"><i class="fa fa-arrow-left"></i>
						Return to Blog</a></li>
			</ul>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1>
						Welcome to the Blog Management page!
					</h1>
					<br/>
					<br/>
					<ol class="breadcrumb">
						<li><a href="index.html"><i class="icon-dashboard"></i>
							Add</a></li>
						<li class="active"><i class="icon-file-alt"></i>  Add New Blog</li>
					</ol>
					<ol class="breadcrumb">
						<li><a href="list"><i class="icon-dashboard"></i>
							Delete</a></li>
						<li class="active"><i class="icon-file-alt"></i> Delete Blog</li>
					</ol>
					<ol class="breadcrumb">
						<li><a href="index.html"><i class="icon-dashboard"></i>
							Modify</a></li>
						<li class="active"><i class="icon-file-alt"></i> Modify Blog</li>
					</ol>
					<ol class="breadcrumb">
						<li><a href="index.html"><i class="icon-dashboard"></i>
							List</a></li>
						<li class="active"><i class="icon-file-alt"></i> List Blogs</li>
					</ol>
				</div>
			</div>
			<!-- /.row -->
